...
public class InfoKeyWordMessage {
    ...
    public static final String REGISTRATION_ERROR_DIFFERENT_PASSWORDS = "registration.error.different_passwords";
    public static final String REGISTRATION_ERROR_FIRST_LAST_NAME_FORMAT = "registration.error.first_last_name_format";
    public static final String REGISTRATION_ERROR_EMAIL_FORMAT = "registration.error.email_format";
